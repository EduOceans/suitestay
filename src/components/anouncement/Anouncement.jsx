...
function Anouncement() {
    ...
    <div className="anouncement-container">
                <div>
                    <img src="https://www.whatsonnetwork.co.uk/uploads/800x600/953c40411cf5099f7a7050033575e0d4.jpg" alt="eagles" className="eagles-img"/>
                </div>
                <div className="anouncement-txt-container">
